/**
 * Alphanumeric String comparator courtesy of Stephen Friedrich.
 *
 * See:
 *   - https://weblogs.java.net/blog/skelvin/archive/2006/01/natural_string.html
 *   - http://www.eekboom.com/java/compareNatural/src/com/eekboom/utils/Strings.java
 *   - http://www.eekboom.com/java/compareNatural/src_test/com/eekboom/utils/TestStrings.java
 *
 */
...
public class TestStrings {
    ...
    /** Application logs */
    private final Logger log = LoggerFactory.getLogger(TestStrings.class);
    ...
    public void testCompareNaturalPerformance() {
        ...
        log.info("avgTimeDefaultSort = {}", avgTimeDefaultSort);

        double avgTimeNaturalSort = totalTimeNaturalSort / runCount;
        log.info("avgTimeNaturalSort = {}", avgTimeNaturalSort);
